    ...
    <>
      ...
      <main className="mx-auto h-[calc(100vh-5rem-0.5rem)] max-w-3xl w-full flex items-center justify-center text-donathell-secondary">
        <div className="flex items-center justify-center flex-col min-h-120 w-full mb-10">
          <div className="w-full bg-[#202123] border-b border-[#101115] py-4 px-6 rounded-t-xl h-16 flex gap-4">
            <DonationFormField label="Name" inputPlaceholder="Senya" />
            <DonationFormField label="Amount" inputPlaceholder="200" />
          </div>
          <textarea
            placeholder="Message..."
            className="w-full placeholder-[#c7ccc8a8] bg-[#202123] rounded-b-xl resize-none h-96 px-6 py-4 focus:outline-none shadow-md"
          ></textarea>
          <button className="self-end bg-[#202123] mt-3 rounded-xl text-xl px-6 py-2 cursor-pointer hover:bg-[#363739] duration-100 shadow-sm">
            Submit
          </button>
        </div>
      </main>
